...
function addKeyBoardSupport() {
    $(window).keydown(function(t) {
        ...
        if(27== t.which) { $("#blocs-lightbox-close-btn").is(":visible") && $("#blocs-lightbox-close-btn").click()}
    })
}
